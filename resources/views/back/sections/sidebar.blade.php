        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="index-2.html"><i class="ti-more"></i>e-Commerce Dashboard</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/component_portlet_draggable.html"><i class="ti-more"></i>Draggable Portlets</a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/charts_echarts_pie_doughnut.html"><i class="ti-more"></i>Pie & Doughnut Chart</a>
                    </li>
                </ul>
            </li>
