        ...
        <div>
            ...
            <form id="search_form" role="search" class="top-nav-search pull-left collapse ml-20">
                ...
                <button type="button" class="btn  btn-default" data-target="#search_form" data-toggle="collapse"
                        aria-label="Close" aria-expanded="true"><i class="mdi mdi-magnify"></i></button>
                </span>
                </div>
            </form>
        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu sm-scrol">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ asset("back/images/user2-160x160.jpg") }}"
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ asset("back/images/user3-128x128.jpg") }}"
                                                 class="rounded-circle" alt="User Image">
                                        </div>
                                        <div class="mail-contnet">
                                            <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{ asset("back/images/user4-128x128.jpg") }}"
                                                 class="rounded-circle" alt="User Image">
                                        </div>
                                        <div class="mail-contnet">
                                            <h4>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset("back/images/avatar/7.jpg") }}" class="user-image rounded-circle"
                             alt="User Image">
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <!-- User image -->
                        <li class="user-header bg-img"
                            style="background-image: url({{ asset("back/images/user-info.jpg") }})" data-overlay="3">
                            <div class="flexbox align-self-center">
                                <img src="{{ asset("back/images/avatar/7.jpg") }}" class="float-left rounded-circle"
                                     alt="User Image">
                        ...
                        <li class="user-body">
                            ...
                            <div class="dropdown-divider"></div>
                            <div class="p-10"><a href="javascript:void(0)" class="btn btn-sm btn-rounded btn-success">View
                                    Profile</a></div>
                        </li>
                    </ul>
                </li>
