...
<head>
    ...
    <!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="{{ asset("back/assets/css/slick.css") }}">
    <link rel="stylesheet" type="text/css" href="{{ asset("back/assets/css/slick-theme.css") }}">

    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="{{ asset("back/assets/css/jsgrid.css") }}">
...
<body data-gr-c-s-loaded="true" cz-shortcut-listen="true">
    ...
    <div class="page-wrapper">
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"></path>
                            ...
                            <div class="single-item slick-initialized slick-slider slick-dotted">
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 1925px; transform: translate3d(-275px, 0px, 0px);">
                                        <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 275px;">
                                            <div>
                                        ...
                                        <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" role="tabpanel" id="slick-slide00" style="width: 275px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div>
                                                        <h3>Welcome to Walter System</h3>
                                        ...
                                        <div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide01" style="width: 275px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div>
                                                        <h3>Welcome to Walter System</h3>
                                        ...
                                        <div class="slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide02" style="width: 275px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div>
                                                        <h3>Welcome to Walter System</h3>
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 275px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div>
                                                        <h3>Welcome to Walter System</h3>
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 275px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div>
                                                        <h3>Welcome to Walter System</h3>
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 275px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div>
                                                        <h3>Welcome to Walter System</h3>
                ...
                <a href="index.html" class="btn btn-primary back-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left">
    ...
    <script src="{{ asset("back/assets/js/slick.js") }}"></script>

    <!-- Jsgrid js-->
    <script src="{{ asset("back/assets/js/jsgrid/jsgrid.min.js") }}"></script>
    <script src="{{ asset("back/assets/js/jsgrid/griddata-invoice.js") }}"></script>
    <script src="{{ asset("back/assets/js/jsgrid/jsgrid-invoice.js") }}"></script>
